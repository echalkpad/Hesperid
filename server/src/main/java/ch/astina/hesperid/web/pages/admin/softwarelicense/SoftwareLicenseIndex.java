 ...
 */
@Secured({"ROLE_ADMIN"})
public class SoftwareLicenseIndex 
{
    @Inject
    ...
    {
        return softwareLicenseDAO.getAllSoftwareLicenses();
    }

    @CommitAfter
    public void onActionFromDelete(Long softwareLicenseId)
    {
        SoftwareLicense sl = softwareLicenseDAO.getSoftwareLicenseForId(softwareLicenseId);
        softwareLicenseDAO.deleteSoftwareLicense(sl);
    }
}
