...
public class AssetOverview
{
    ...
    {
        return observerDAO.getExternalObservers(asset);
    }

    public List<Observer> getClientObservers()
    {
        return observerDAO.getClientObservers(asset);
    }
    ...
    public String getAssetGraphForAllAssetRelations() throws Exception
    {
        List<Asset> a = assetDAO.getAllRelatedAssets(asset);
        a.add(asset);
